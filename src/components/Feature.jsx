    ...
    return(
      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 bg-blue-100 p-3 rounded-lg shrink-0" viewBox="0 0 32 32">
          ...
          <div>
            ...
            <p class="text-gray-600 text-sm">Tailor our product to suit your needs Expand your reach with our global network.</p>
          </div>
        </div>

        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 bg-blue-100 p-3 rounded-lg shrink-0" viewBox="0 0 682.667 682.667">
            <defs>
        ...
        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 bg-blue-100 p-3 rounded-lg shrink-0" viewBox="0 0 512.001 512.001">
          ...
          <div>
            ...
            <p class="text-gray-600 text-sm">Tailor our product to suit your needs 24/7 customer support for all your inquiries.</p>
          </div>
        </div>

        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 bg-blue-100 p-3 rounded-lg shrink-0" viewBox="0 0 24 24">
        ...
        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 h-12 bg-blue-100 p-3 rounded-lg shrink-0" viewBox="0 0 504.69 504.69">
          ...
          <div>
            <h3 class="text-gray-800 text-xl font-semibold mb-3">Global Reach</h3>
            <p class="text-gray-600 text-sm">Tailor our product to suit your needs Expand your reach with our global network.</p>
          </div>
        </div>
        ...
        <div class="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            <h3 class="text-gray-800 text-xl font-semibold mb-3">Communication</h3>
            <p class="text-gray-600 text-sm">Tailor our product to suit your needs Seamless communication for your team.</p>
          </div>
        </div>
      </div>
    </div>
